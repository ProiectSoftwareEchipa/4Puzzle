...
namespace _4Puzzle
{
    ...
    public sealed partial class SinglePlayerHard : Page
    {
        ...
        private ImageBrush imageBrushFig7_happy;

        private ImageBrush imageBrushFig8_happy;
        ...
        public SinglePlayerHard()
        {
            ...
            this.imageBrushFig7_happy = new ImageBrush();
            imageBrushFig7_happy.ImageSource = new BitmapImage(new Uri("ms-appx:///Images/fig7_happy.png"));

            this.imageBrushFig8_happy = new ImageBrush();
            imageBrushFig8_happy.ImageSource = new BitmapImage(new Uri("ms-appx:///Images/fig8_happy.png"));
        ...
        private void Rectangle_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (CheckEndGame)
            {
                ...
                {
                    if (singlePlayerHardWins == 3)
                    {
                        PopupImage.Source = new BitmapImage(new Uri("ms-appx:///Images/popup3WinsHard.png"));
                    }
                    else
                    {
        ...
        private void CheckNewHappyLine(int i)
        {
            ...
            if (currentList.Count == gameSize && !currentList.Contains(0))
            {
                ...
                for (int j = 0; j < gameSize; j++)
                {
                    ...
                    if (rectangleMatrix[i, j].Fill == imageBrushFig7)
                    {
                        rectangleMatrix[i, j].Fill = imageBrushFig7_happy;
                    }
                    if (rectangleMatrix[i, j].Fill == imageBrushFig8)
                    {
                        rectangleMatrix[i, j].Fill = imageBrushFig8_happy;
                    }
                }
            }
        }
        ...
        private void RemoveHappyFaces()
        {
            for (int i = 0; i < gameSize; i++)
            {
                ...
                for (int j = 0; j < gameSize; j++)
                {
                    ...
                    if (rectangleMatrix[i, j].Fill == imageBrushFig7_happy)
                    {
                        rectangleMatrix[i, j].Fill = imageBrushFig7;
                    }
                    if (rectangleMatrix[i, j].Fill == imageBrushFig8_happy)
                    {
                        rectangleMatrix[i, j].Fill = imageBrushFig8;
                    }
                }
            }
        }
        ...
        private void InitializePositionMatrix()
        {
            for (int i = 0; i < gameSize; i++)
            {
                for (int j = 0; j < gameSize; j++)
                {
                    ...
                    if (rectangleMatrix[i, j].Fill == imageBrushFig7)
                    {
                        rectanglePositionMatrix[i, j] = 7;
                    }
                    if (rectangleMatrix[i, j].Fill == imageBrushFig8)
                    {
                        rectanglePositionMatrix[i, j] = 8;
                    }
                }
            }
        }
